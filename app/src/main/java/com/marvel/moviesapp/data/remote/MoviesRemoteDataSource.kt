...
interface MoviesRemoteDataSource {
    ...
    @GET("movie/top_rated")
    suspend fun getTopRatedMovies(@Query("page") page: Int): BaseListingResponse<RemoteMovie>

    @GET("movie/now_playing")
    suspend fun getNowPlayingMovies(@Query("page") page: Int): BaseListingResponse<RemoteMovie>

    @GET("search/movie")
    suspend fun searchMovies(
        @Query("query") query: String,
        @Query("page") page: Int
    ): BaseListingResponse<RemoteMovie>
